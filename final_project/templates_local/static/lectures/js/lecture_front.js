...
fetch(`http://127.0.0.1:8000/lectures/lists?student_id=${studentId}`)
...
function searchLectures() {
    ...
    const url = `http://127.0.0.1:8000/lectures/lists/search?student_id=${studentId}&lec_id=${lectureCode}&lec_name=${lectureName}`;
...
function applyForLecture(event) {
    ...
    const url = `http://127.0.0.1:8000/lectures/apply/`;
