...
fetch(`https://univ.umjiw99.shop/lectures/lists?student_id=${studentId}`)
...
function searchLectures() {
    ...
    const url = `https://univ.umjiw99.shop/lectures/lists/search?student_id=${studentId}&lec_id=${lectureCode}&lec_name=${lectureName}`;
...
function applyForLecture(event) {
    ...
    const url = `https://univ.umjiw99.shop/lectures/apply/`;
